                            ...
                            <div className="space-y-6">
                                ...
                                <div className="border-t border-light-border dark:border-dark-border pt-6 space-y-4">
                                    ...
                                    <div className="p-4 rounded-lg border border-light-border dark:border-dark-border bg-light-surface dark:bg-dark-bg">
                                        <div className="flex items-center justify-between mb-3">
                                            <div className="flex items-center gap-2.5">
                                                <div className="w-7 h-7 rounded-lg bg-blue-500/10 flex items-center justify-center">
                                                    <span className="text-blue-500 text-sm font-bold">T</span>
                                                </div>
                                                <div>
                                                    <div className="text-sm font-semibold">Telegram API ID</div>
                                                </div>
                                            </div>
                                            <a
                                        ...
                                        <div className="relative">
                                            <input
                                                type={showApiKeys.telegramId ? 'text' : 'password'}
                                            ...
                                            <button
                                                type="button"
                                                onClick={() => setShowApiKeys(prev => ({ ...prev, telegramId: !prev.telegramId }))}
                                                className="absolute right-2 top-1/2 -translate-y-1/2 p-1.5 rounded text-light-text-secondary dark:text-dark-text-secondary hover:text-light-text-primary dark:hover:text-dark-text-primary transition-colors"
                                            >
                                                {showApiKeys.telegramId ? <EyeOff className="w-4 h-4" /> : <Eye className="w-4 h-4" />}
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div className="p-4 rounded-lg border border-light-border dark:border-dark-border bg-light-surface dark:bg-dark-bg">
                                        <div className="flex items-center justify-between mb-3">
                                            <div className="flex items-center gap-2.5">
                                                ...
                                                <div>
                                                    <div className="text-sm font-semibold">Telegram API Hash</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="relative">
                                            <input
                                                type={showApiKeys.telegramHash ? 'text' : 'password'}
                                            ...
                                            <button
                                                type="button"
                                                onClick={() => setShowApiKeys(prev => ({ ...prev, telegramHash: !prev.telegramHash }))}
                                                className="absolute right-2 top-1/2 -translate-y-1/2 p-1.5 rounded text-light-text-secondary dark:text-dark-text-secondary hover:text-light-text-primary dark:hover:text-dark-text-primary transition-colors"
                                            >
                                                {showApiKeys.telegramHash ? <EyeOff className="w-4 h-4" /> : <Eye className="w-4 h-4" />}
                                            </button>
                                        </div>
                                    </div>
                                        ...
                                        <button
                                            ...
                                            onClick={async () => {
                                                try {
                                                    ...
                                                    showNotification('Opening mail client...', 'success')
                                                } catch (err) {
                                                    showNotification('Failed to open mail client: ' + err.message, 'error')
                                                } finally {
